...
```
These three bubble charts help us understand the correlation between the most predominant skills in the survey. The interpretation of the bubble charts are similar to those of the heat map. The top chart reflects little correlation between R and Matlab. However, the middle chart reflects that those who have dedicated themselves in statistical fields have garnered significant strength in R, but have not been practicing Github as prevalently. Likewise in the bottom chart, those in statistical fields are stronger in Matlab than Github which further affirms our conclusion.
